...
> [!note]- 🛤️ Definición y Cálculo
> 
> La **integral de línea** de un campo vectorial **F** a lo largo de una curva C es:
> 
> ```
...
> 
> - **Trabajo**: Energía para mover partícula en campo de fuerzas
> - **Flujo**: Cantidad que atraviesa la curva
> - **Circulación**: Tendencia a rotar alrededor de curva cerrada
> 
> **Cálculo con parametrización:**
> 
> Si C está parametrizada por **r**(t) = ⟨x(t), y(t), z(t)⟩, t ∈ [a, b]:
> 
> ```
...
> ```mermaid
> flowchart TD
>     A[Integral de Línea<br/>∫_C F·dr] --> B[1. Parametrizar curva<br/>r(t), t ∈ [a,b]]
>     B --> C[2. Calcular r'(t)]
>     C --> D[3. Sustituir en F<br/>F(r(t))]
>     D --> E[4. Producto punto<br/>F(r(t))·r'(t)]
>     E --> F[5. Integrar<br/>∫ₐᵇ ... dt]
>     
>     style A fill:#e1f5ff
>     style F fill:#e1ffe1
> ```
...
> |Propiedad|Fórmula|
> |---|---|
> |**Linealidad**|∫_C (αF + βG)·dr = α∫_C F·dr + β∫_C G·dr|
> |**Dirección opuesta**|∫_{-C} F·dr = -∫_C F·dr|
> |**Concatenación**|∫_{C₁+C₂} F·dr = ∫_{C₁} F·dr + ∫_{C₂} F·dr|
