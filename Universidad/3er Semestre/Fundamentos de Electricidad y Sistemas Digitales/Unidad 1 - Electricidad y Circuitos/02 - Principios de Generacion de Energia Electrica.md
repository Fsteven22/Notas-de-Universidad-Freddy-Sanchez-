...
## 🧲 Ley de Faraday y Principio Electromagnético
...
> [!success]- 🗺️ Del Generador al Consumidor
>
> ```mermaid
> graph LR
>     A[Generación<br/>⚡ ~10–25 kV] -->|Transformador<br/>elevador| B[Transmisión<br/>138–500 kV]
>     B -->|Líneas de alta<br/>tensión| C[Subestación<br/>Reductora]
>     C -->|Media tensión<br/>6–34 kV| D[Distribución]
>     D -->|Transformador<br/>de barrio| E[Consumidor<br/>110–220 V]
>
>     style A fill:#fff4e1
>     style B fill:#ffe1e1
>     style C fill:#e1f5ff
...
> ```
>
> | Etapa | Voltaje típico | Propósito |
> |---|---|---|
> | **Generación** | 10–25 kV | Producción de energía |
> | **Transmisión** | 138–500 kV | Transporte a larga distancia con mínimas pérdidas |
> | **Subtransmisión** | 34–138 kV | Enlace entre transmisión y distribución |
> | **Distribución** | 6–34 kV | Reparto a zonas urbanas y rurales |
> | **Consumo** | 110–220 V | Uso final en hogares e industria |
>
> > **¿Por qué se eleva el voltaje para transmitir?**
> > Las pérdidas en una línea son $P_{pérd} = I^2 \cdot R$. Al elevar el voltaje, la corriente disminuye y las pérdidas se reducen drásticamente.
> > 
![[ChatGPT Image 19 may 2026, 22_52_00.png]]
...
**Tags:** #generacion #electricidad #faraday #hidroelectrica #solar #eolica #termoelectrica #nuclear #EYAG1037 #FESD #ESPOL #unidad1
