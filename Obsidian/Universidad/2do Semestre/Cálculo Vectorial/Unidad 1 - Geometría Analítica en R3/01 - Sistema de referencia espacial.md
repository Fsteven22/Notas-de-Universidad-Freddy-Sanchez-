...
> [!success]- 🖥️ Modelado 3D
> 
> **Sistema de coordenadas en gráficos:**
> 
> - Cada vértice de un modelo 3D se representa como (x, y, z)
> - Las transformaciones (rotación, traslación, escala) operan sobre estos puntos
> - Motores de videojuegos usan ℝ³ constantemente
> 
> **Ejemplo en código:**
> 
> ```python
...
> # Crear punto
> P = Punto3D(3, 4, 5)
> print(f"Punto: ({P.x}, {P.y}, {P.z})")
> print(f"Ubicación: {P.octante()}")
> ```

### 🏗️ En Ingeniería y Arquitectura

> [!note]- 📐 Diseño Espacial
> 
> **Aplicaciones directas:**
> 
> - **CAD (Computer-Aided Design):** Modelado de estructuras
> - **BIM (Building Information Modeling):** Coordenadas de elementos constructivos
> - **Topografía:** Levantamientos tridimensionales
> 
> **Ejemplo práctico:**
> 
> - Esquina de un edificio: (0, 0, 0)
> - Dimensiones: 20m (largo) × 15m (ancho) × 30m (alto)
> - Esquina opuesta: (20, 15, 30)
...
> 
> - **Latitud:** análoga a coordenada Y
> - **Longitud:** análoga a coordenada X
> - **Altitud:** análoga a coordenada Z
> 
> **Conversión aproximada:**
> 
> - Sistema geodésico → Sistema cartesiano local
> - Usado en navegación, mapas, aplicaciones móviles
